	...
	<div class="bg-gray-50"> 
		<div class="card-body">
			<div class="overflow-x-auto">
				{{-- SEARCH --}}
				<input type="text" wire:model.live="search" placeholder="Cari data..." class="w-64 rounded-md border border-gray-300 px-3 py-2 text-sm m-4 focus:border-blue-500 focus:ring focus:ring-blue-200" />

				{{-- PERPAGE --}}
				<select wire:model.live="perPage" class="w-52 rounded-md border border-gray-300 px-3 py-2 text-sm m-4 focus:border-blue-500 focus:ring focus:ring-blue-200">
